...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="t.me/TubiSupportBot")],
        ]
    )
...
async def plan(client, message):
    plan_text = (
        "> **Premium Price**:\n\n💰 Starting from $2 or 200 INR accepted via **__UPI and CRYPTO__** (terms and conditions apply).\n\n"
        "📥 **Download Limit**: Users can download up to 100,000 files in a single batch command.\n\n"
        "🛑 **Batch**: You will get one mode /batch.\n\n"
...
async def see_plan(client, callback_query):
    plan_text = (
        "> **Premium Price**\n\n💰 Starting from $2 or 200 INR accepted via **__UPI and CRYPTO__** (terms and conditions apply).\n\n"
        "📥 **Download Limit**: Users can download up to 100,000 files in a single batch command.\n\n"
        "🛑 **Batch**: You will get one modes /batch.\n\n"
        "- Users are advised to wait for the process to automatically cancel before proceeding with any downloads or uploads.\n\n"
